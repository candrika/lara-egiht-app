      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <form method="post" action="/tambah/transaksi">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-sm-5">
                <select class="form-select" aria-label="Default select example" name="jenis_kategori">
                  <option value="" seleteced>--Pilih Kategori--</option>
                  @foreach($list as $ls)
            ...
            <div class="mb-3 row">
              ...
              <div class="col-sm-5">
                <select class="form-select" aria-label="Default select example" name="jenis_transaksi">
                  <option value="" seleteced>--Pilih Transaksi--</option>
            ...
            <div class="mb-3 row">
              ...
              <div class="col-sm-5">
                <input type="text" class="form-control" value="" name="nominal" autocomplate="false" style="text-align:right">
              </div>
            </div>
            <div class="mb-3 row">
              <label for="staticEmail" class="col-sm-2 col-form-label">Deskripsi</label>
              <div class="col-sm-5">
                <textarea class="form-control" autocomplate="false" name="deskripsi"></textarea>
              </div>
            </div>
            <div class="mb-3 row">
