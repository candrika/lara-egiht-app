        ...
        <table class="table table-striped table-sm">
          ...
          <tbody>
            ...
            <tr>
                ...
                <td>{{$out->deskripsi}}</td>
                <th><a href="/edit_pengeluaran/{{$out->list_kategori_id}}" class="btn btn-info btn-sm">Edit</a>&nbsp;<a href="/hapus_pengeluaran/{{$out->list_kategori_id}}" class="btn btn-danger btn-sm">Hapus</a></th>
            </tr>
            @endforeach
          </tbody>
        </table>
